<template>
    ...
    <main class="content container" v-else-if="productLoadingFailed">Произошла ошибка <button @click.prevent="loadProduct">Попробовать ещё раз</button></main>
      ...
      <div class="item__info">
        ...
        <div class="item__form">
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <div v-show="productAddSending">Идет добавление товара в корзину...</div>
            <div v-show="productAdded">Товар успешно добавлен в корзину</div>
            <div v-show="productAddError">Произошла ошибка при добавлении товара</div>
          </form>
        </div>
      </div>
...
export default {
    ...
    methods: {
      ...
      addToCart(){
        ...
        .catch(() => this.productAddError = true)
