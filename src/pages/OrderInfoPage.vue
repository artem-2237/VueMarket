<template>
    ...
    <section class="cart">
      <form class="cart__form form" action="#" method="POST">
        ...
        <OrderProductsList :products="products" :total-price="$store.state.orderInfo.totalPrice" :order-button="false"/>
...
export default {
    ...
    computed: {
        products() {
            if (this.$store.state.orderInfo) return this.$store.state.orderInfo.basket.items.map(item => {
                return {
